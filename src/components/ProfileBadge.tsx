...
const ProfileBadge = React.forwardRef<HTMLSpanElement, ProfileBadgeProps>(
  ({ children, className, variant = 'default', ...props }, ref) => {
    const baseClasses = "inline-flex items-center justify-center rounded-md px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 transition-colors";
