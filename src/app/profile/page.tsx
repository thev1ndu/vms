      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-400">
            Manage your nickname and profile information
          </p>
        </div>

        {/* Nickname Section */}
        <Card className="bg-transparent border-2 border-[#9FFF82] rounded-none">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm text-gray-300">Current Nickname</label>
              <div className="flex items-center gap-2">
                <Badge
                  variant="outline"
                  className="text-white border-[#9FFF82]"
                >
            ...
            <div className="space-y-2">
              <label className="text-sm text-gray-300">New Nickname</label>
              <Input
                value={newChatTag}
            ...
            <Button
              ...
              className="w-full bg-[#9FFF82] hover:bg-[#9FFF82] text-black rounded-none"
            >
        ...
        <Card className="bg-transparent border-2 border-[#A5D8FF] rounded-none">
          <CardHeader>
            <CardTitle className="text-white">Nickname Rules</CardTitle>
          </CardHeader>
